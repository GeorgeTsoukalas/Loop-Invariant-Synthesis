...
# This (only load_trace) is intended from loading the pre-computed trace data provided by the cln2inv implementation 
# See more in new_main.py for explanation
