# some of the variables are commented out here, this is because some variabes are instantiated but never used
# I could not figure out how to discern which variables fall into this category automatically, so I did this manually
